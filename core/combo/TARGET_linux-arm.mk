...
TARGET_TOOLS_PREFIX := prebuilts/gcc/$(HOST_PREBUILT_TAG)/arm/arm-linux-androideabi-4.7/bin/arm-linux-androideabi-
endif
...
ifeq ($(ARCH_ARM_LOW_OPTIMIZATION),true)
...
ifneq ($(filter 4.7.%, $(shell $(TARGET_CC) --version)),)
